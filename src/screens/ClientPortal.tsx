    ...
    <div style={{padding:28,overflowY:'auto',flex:1}}>
      <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-start',marginBottom:28}}>
        <div>
          ...
          <p style={{fontSize:11,color:'var(--slate)',marginTop:4}}>Branded client-facing view · Holland, Augusta</p>
        </div>
      ...
      <div style={{maxWidth:620,margin:'0 auto',background:'var(--bg2)',border:'1px solid var(--border)',borderRadius:14,padding:28}}>
        ...
        <div style={{textAlign:'center',paddingBottom:24,borderBottom:'1px solid var(--border)',marginBottom:24}}>
          ...
          <div style={{fontSize:12,color:'var(--ivory-dim)'}}>Welcome back, Augusta. Your adventure awaits.</div>
        </div>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:12,marginBottom:16}}>
          <div style={{background:'var(--bg4)',borderRadius:10,padding:16,textAlign:'center',border:'1px solid var(--border)'}}>
            ...
            <div className="playfair" style={{fontSize:42,color:'var(--champagne)',lineHeight:1}}>15</div>
          ...
          <div style={{background:'var(--bg4)',borderRadius:10,padding:16,border:'1px solid var(--border)'}}>
            ...
            <div className="playfair" style={{fontSize:18,color:'var(--ivory)'}}>Capri</div>
            <div style={{fontSize:10,color:'var(--slate)',marginTop:4}}>Jul 5–14 · 9 nights</div>
          </div>
        </div>
        ...
        <div style={{background:'var(--bg3)',border:'1px solid var(--border)',borderRadius:10,padding:16,marginBottom:16}}>
          <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:8}}>
            ...
            <span className="badge b-og">Jul 1 · 11 days</span>
          </div>
          <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:12}}>
            <span style={{fontSize:11,color:'var(--slate)'}}>Final Balance (50%)</span>
            <span className="playfair" style={{fontSize:22,color:'var(--champagne)'}}>$8,500</span>
          </div>
        ...
        <div style={{textAlign:'center',fontSize:10,color:'var(--slate)'}}>
          Questions? Contact Halie M. · <span style={{color:'var(--champagne)'}}>halie@agency.com</span>
        </div>
      </div>
    </div>
  );
